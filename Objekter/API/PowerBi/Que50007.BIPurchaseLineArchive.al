query 50007 BIPurchase_Line_Archive
{
    APIGroup = 'Lykketronic';
    APIPublisher = 'Dynalogic';
    APIVersion = 'v1.0';
    EntityName = 'Purchase_Line_Archive';
    EntitySetName = 'PowerBI_Purchase_Line_Archive';
    QueryType = API;

    elements
    {
        dataitem(purchaseLineArchive; "Purchase Line Archive")
        {
