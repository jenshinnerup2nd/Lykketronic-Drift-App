query 50029 BIService_shipment_Header
{
    APIGroup = 'Lykketronic';
    APIPublisher = 'Dynalogic';
    APIVersion = 'v1.0';
    EntityName = 'Service_shipment_Header';
    EntitySetName = 'PowerBI_Service_shipment_Header';
    QueryType = API;

    elements
    {
        dataitem(serviceShipmentHeader; "Service Shipment Header")
        {
            ...
            column(linkServiceToServiceItem; "Link Service to Service Item")
            {
            }
            column(priority; Priority)
            {
            }
            column(allocatedHours; "Allocated Hours")
            {
            }
            ...
            column(noOfUnallocatedItems; "No. of Unallocated Items")
            {
            }
            column(orderTime; "Order Time")
            {
            }
            column(defaultResponseTimeHours; "Default Response Time (Hours)")
            {
            }
            ...
            column(responseDate; "Response Date")
            {
            }
            ...
            column(finishingDate; "Finishing Date")
            {
            }
            column(finishingTime; "Finishing Time")
            {
            }
            column(contractServHoursExist; "Contract Serv. Hours Exist")
            {
            }
            column(reallocationNeeded; "Reallocation Needed")
            {
            }
            column(notifyCustomer; "Notify Customer")
            {
            }
            column(maxLaborUnitPrice; "Max. Labor Unit Price")
            {
            }
            column(warningStatus; "Warning Status")
            {
            }
            column(noOfAllocations; "No. of Allocations")
            {
            }
            column(contractNo; "Contract No.")
            {
            }
            column(shipToFaxNo; "Ship-to Fax No.")
            {
            }
            ...
            column(shipToPhone2; "Ship-to Phone 2")
            {
            }
            column(serviceZoneCode; "Service Zone Code")
            {
            }
            column(expectedFinishingDate; "Expected Finishing Date")
            {
            }
