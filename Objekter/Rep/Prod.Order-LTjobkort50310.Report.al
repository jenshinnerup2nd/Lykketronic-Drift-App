...
Report 50310 "Prod. Order - LT jobkort 50310"
{
    // 191213 VD/age   Lykketronic "jobkort"
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Prod. Order - LT jobkort 50310.rdl';
    ...
    dataset
    {
        dataitem("Production Order"; "Production Order")
        {
            ...
            dataitem("<Prod. Order Comment>"; "Prod. Order Component")
            {
                DataItemLink = "Prod. Order No." = field("No.");
                DataItemTableView = sorting(Status, "Prod. Order No.", "Prod. Order Line No.", "Line No.");
            ...
            begin
                ...
                if CommentLine.FindFirst then
                    commentTxt := CommentLine.Comment;                                                                                  // :191213
            end;
