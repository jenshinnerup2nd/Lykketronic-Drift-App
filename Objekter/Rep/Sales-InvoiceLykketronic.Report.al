...
Report 50206 "Sales - Invoice Lykketronic"
{
    ...
    var
        ...
        DocumentReferenceCaptOLD: label 'If your bank supports FIK (Danish bank standard), then use the following information:', Comment = 'Translate to "Hvis din bank underst¢tter FIK (fælles indbetalingkort), så benyt denne information:"';
        ...
        stdTextA: Text[100];
        stdTextB: Text[100];
        DocumentReferenceCaptionbl: label 'Payment-ID', Comment = 'Translate to "Hvis din bank underst¢tter FIK (fælles indbetalingkort), så benyt denne information:"';
